...
@Component({
  selector: 'app-cmonth',
  templateUrl: './cmonth.component.html',
  styleUrls: ['./cmonth.component.css']
})
export class CmonthComponent implements OnInit {
  ...
  private fetchCompesations() {
    this.http.get(`http://localhost:8080/apis/compesationbydate?id=${this.employeeID}&month=${this.compesationMonth}&year=${this.compesationYear}`).subscribe((compesationRes) => {
